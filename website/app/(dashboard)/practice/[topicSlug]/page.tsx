...
import { getPracticeTopicAccent, getPracticeTopicIcon } from "@/lib/practiceCategoryIcons";

export default function PracticeTopicPage({ params }: { params: Promise<{ topicSlug: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      {!sessionActive && <BackNavigation href="/practice" label="Back to Practice" />}
          ...
          <div className="flex items-start justify-between gap-6">
            <div>
              {(() => {
                ...
                return (
                  <div
                    className={`flex h-14 w-14 items-center justify-center rounded-full ${topicAccent.bg}`}
                  >
                    <TopicIcon
                      size={22}
                      strokeWidth={2}
              ...
              <h1 className="font-display mt-4 text-3xl font-extrabold text-bone">{topic.title}</h1>
