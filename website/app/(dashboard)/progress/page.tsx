...
import CareerIntelligencePanel from "@/components/progress/ai/CareerIntelligencePanel";
...
export default function ProgressPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <div className="mb-8">
        <h1 className="font-display text-3xl font-extrabold text-bone md:text-4xl">Progress</h1>
      ...
      {!loading && !hasActivity && (
        <div className="space-y-8">
          ...
          {!milestonesLoading && milestones && <MilestonesSection milestones={milestones} />}
        </div>
      )}
